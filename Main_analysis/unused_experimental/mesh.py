...
from Microscopy_pipelines.slab_microscopy import *
'''
This script was intended to be used to rotate a dataset (or part of it) to orient the Z axis of the dataset
directly to the cortical surface (rotate_to_surface function). Also features a fancy surface plot before and after rotation.
'''
